...
function renderContent(id, showPast) {
  ...
  for (const key of sections) {
    ...
    for (let i = 0; i < entries.length; i++) {
      ...
      if (key === 'mission' && (/にゃんチケドロップステージを3回クリアしよう|XPドロップステージを5回クリアしよう|レジェンドストーリーを5回クリアしよう|ガマトトを探検に出発させて7回探検終了させよう|ウィークリーミッションをすべてクリアしよう|ガマトトを探検に出発させて10回探検終了させよう|レジェンドストーリーを10回クリアしよう|対象ステージは「にゃんこミッションとは？」をご確認下さい|ガマトトを探検に出発させて10回探検終了させよう|マタタビドロップステージを3回クリアしよう/.test(text))) continue;
